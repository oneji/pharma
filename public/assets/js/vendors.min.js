...
! function (e, t) {
    ...
    var O = function (e) {
            ...
            return f(t, d), a(t, [{
                ...
                value: function (e, t, n, o, i) {
                    ...
                    o ? function e(t, n, r) {
                        ...
                        return t
                    }(u, n, i) : u = r({}, u, n), b(this.data, s, u), a.silent || this.emit("added", e, t, n)
                }
            }, {
        ...
        j = function (e) {
            function n(e) {
                ...
                return o(this, n), t = u(this, l(n).call(this)), d.call(s(t)), r = ["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat"], i = e, a = s(t), r.forEach(function (e) {
                    i[e] && (a[e] = i[e])
                }), t.options = c, void 0 === t.options.keySeparator && (t.options.keySeparator = "."), t.logger = h.create("translator"), t
            }
            return f(n, d), a(n, [{
                key: "changeLanguage",
                value: function (e) {
                    ...
                    if (b && h && ("string" != typeof h && "boolean" != typeof h && "number" != typeof h) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(y) < 0 && ("string" != typeof m || "[object Array]" !== y)) {
                        ...
                        if (j || R || N) {
                            ...
                            if ("fallback" === this.options.saveMissingTo && E && E[0])
                                for (var P = 0; P < E.length; P++) C.push(E[P]);
                            ...
                            var F = function (e, t) {
                                o.options.missingKeyHandler ? o.options.missingKeyHandler(e, l, t, N ? n.defaultValue : h, N, n) : o.backendConnector && o.backendConnector.saveMissing && o.backendConnector.saveMissing(e, l, t, N ? n.defaultValue : h, N, n), o.emit("missingKey", e, l, t, h)
                            };
                ...
                value: function (e, t, n, o) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, n, o.usedLng, o.usedNS, o.usedKey, {
                        ...
                        this.options.interpolation.defaultVariables && (a = r({}, this.options.interpolation.defaultVariables, a)), e = this.interpolator.interpolate(e, a, n.lng || this.language, n), !1 !== n.nest && (e = this.interpolator.nest(e, function () {
    ...
    var P = function () {
            function e(t) {
                var n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                o(this, e), this.languageUtils = t, this.options = r, this.logger = h.create("pluralResolver"), this.rules = (n = {}, C.forEach(function (e) {
        ...
        F = function () {
            function e() {
                ...
                o(this, e), this.logger = h.create("interpolator"), this.options = t, this.format = t.interpolation && t.interpolation.format || function (e) {
                    return e
                }, this.init(t)
            }
            return a(e, [{
    ...
    var T = function (e) {
        function t(e, n, r) {
            ...
            return o(this, t), i = u(this, l(t).call(this)), d.call(s(i)), i.backend = e, i.store = n, i.languageUtils = r.languageUtils, i.options = a, i.logger = h.create("backendConnector"), i.state = {}, i.queue = [], i.backend && i.backend.init && i.backend.init(r, a.backend, a), i
        }
        return f(t, d), a(t, [{
            key: "queueLoad",
            value: function (e, t, n, r) {
    ...
    return new(function (e) {
        function n() {
            ...
            if (o(this, n), e = u(this, l(n).call(this)), d.call(s(e)), e.options = V(t), e.services = {}, e.logger = h, e.modules = {
                    external: []
        ...
        return f(n, d), a(n, [{
            ...
            value: function () {
                ...
                if ("function" == typeof n && (o = n, n = {}), this.options = r({}, {
                        debug: !1,
                        initImmediate: !0,
                        ns: ["translation"],
                        defaultNS: ["translation"],
                    ...
                    }, this.options, V(n)), this.format = this.options.interpolation.format, o || (o = U), !this.options.isClone) {
                    ...
                    var s = this.services;
                    s.logger = h, s.resourceStore = this.store, s.languageUtils = a, s.pluralResolver = new P(a, {
                        prepend: this.options.pluralSeparator,
                        compatibilityJSON: this.options.compatibilityJSON,
                        simplifyPluralSuffix: this.options.simplifyPluralSuffix
                    }), s.interpolator = new F(this.options), s.backendConnector = new T(i(this.modules.backend), s.resourceStore, s, this.options), s.backendConnector.on("*", function (t) {
            ...
            value: function () {
                ...
                }), a.init(i, o), a.translator.options = a.options, a
            }
        }]), n
    }())
});
...
! function (t, e) {
    ...
    var c = function () {
        function e(t) {
            ...
            ! function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.init(t, n), this.type = "backend"
        }
        var n, o, r;
        return n = e, (o = [{
            key: "init",
