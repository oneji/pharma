            ...
            <div class="col s12 m6 xl3">
                <div class="card">
                    <div class="card-content cyan white-text">
                        <p class="card-stats-title"><i class="material-icons">content_copy</i> В рассмотрении</p>
                        <h4 class="card-stats-number white-text">{{ $stats['allRequestTypesCount']['underRevision'] }}</h4>
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'under_revision' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 xl3">
                <div class="card">
                    <div class="card-content red accent-2 white-text">
                        <p class="card-stats-title"><i class="material-icons">content_copy</i> Отправленные</p>
                        <h4 class="card-stats-number white-text">{{ $stats['allRequestTypesCount']['sent'] }}</h4>
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'sent' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 xl3">
                <div class="card">
                    <div class="card-content orange lighten-1 white-text">
                        ...
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'prepared' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 xl3">
                <div class="card">
                    <div class="card-content green lighten-1 white-text">
                        ...
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'shipped' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 xl6">
                <div class="card">
                    <div class="card-content blue lighten-1 white-text">
                        ...
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'paid' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 xl6">
                <div class="card">
                    <div class="card-content red lighten-1 white-text">
                        ...
                        <p class="card-stats-compare">
                            <a class="white-text" href="{{ route('requests.getByStatus', [ 'status' => 'cancelled' ]) }}">Просмотреть</a>
                        </p>
                    </div>
                </div>
            </div>
